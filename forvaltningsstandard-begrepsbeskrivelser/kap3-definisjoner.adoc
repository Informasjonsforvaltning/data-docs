== 3. Definisjon av de mest sentrale begrepene i denne standarden
...
Kilde:: Sitat fra NS-ISO 1087-1:2000: Terminologiarbeid - Ordliste - Del 1: Teori og anvendelser


http://www.standard.no/toppvalg/termbasen/Termpost/?TermPostId=35355
...
Frarådet term:: term (nb); term (nn); term (en); konsept (nb); konsept (nn); concept (en)
