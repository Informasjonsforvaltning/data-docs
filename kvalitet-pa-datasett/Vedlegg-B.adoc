...
Dette vedlegget inneholder først forslag til hvordan beskrivelse av kvalitet på datasett skal kunne implementeres i DCAT-AP-NO. Vedlegget inneholder deretter eksempler på hvordan selve beskrivelsene kan uttrykkes ved å bruke DQV. Kapittel <<6.3 Kvalitetsdimensjon Kompletthet/Dekning (completeness/coverage)>> med <<6.3.1 Kvalitetsdeldimensjon Underdekning (undercoverage/omission)>> og kvalitetsmålene der under, viser et relativt komplett eksempel på hva som trengs for å beskrive “Dekning” ved å bruke DQV.
...
=== 6.1 Implementering i DCAT-AP-NO
...
Jf. figuren ovenfor som er gjengitt fra kapittel <<3 Begreper og definisjoner>>, foreslår vi følgende:
...
=== 6.2 Kvalitetsdimensjon Nøyaktighet (accuracy)
...
[6.3 Kvalitetsdimensjon Kompletthet/Dekning (completeness/coverage)]
=== 6.3 Kvalitetsdimensjon Kompletthet/Dekning (completeness/coverage)
...
==== 6.3.1 Kvalitetsdeldimensjon Underdekning (undercoverage/omission)
...
===== 6.3.1.1 Kvalitetsmål Manglende elementer (missing items)
...
===== 6.3.1.2 Kvalitetsmål Antall manglende elementer (number of missing items)
...
===== 6.3.1.3 Kvalitettsmål Andel manglende elementer (rate of missing items)
...
==== 6.3.2 Kvalitetsdeldimensjon Overdekning (overcoverage/commission)
...
==== 6.3.3 Kvalitetsdeldimensjon Selektivitet (selectivity)
...
==== 6.3.4 Kvalitetsdeldimensjon Dublett (redundancy/duplicate)
...
=== 6.4 Kvalitetsdimensjon Aktualitet (currentness/timeliness)
...
=== 6.5 Kvalitetsdimensjon Samsvar (compliance/conformity)
...
==== 6.5.1 Kvalitetsbeskrivelse I samsvar med (conforms to)
...
=== 6.6 Kvalitetsdimensjon Tilgjengelighet (availability)
...
=== 6.7 Kvalitetsdimensjon Relevans (relevancy)
...
==== 6.7.1 Ikke-kvantitativ/fritekst beskrivelse Bruksformål (specific usage)
...
==== 6.7.2 Ikke-kvantitativ/fritekst beskrivelse Egnethet (usability)
