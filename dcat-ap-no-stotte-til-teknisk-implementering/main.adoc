...
include::datasett\tilgangsniva.adoc[]
...
// (utgivelsesdato)
include::datasett\testdatasett.adoc[]
include::datasett\dekningsomrade.adoc[]
include::datasett\tidsrom.adoc[]
include::datasett\type.adoc[]
...
include::distribusjon\tilgangsURL.adoc[]
